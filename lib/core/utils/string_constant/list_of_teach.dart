class ListOfTeach {
  static List<Teachers> listOfTeachers = [
    ...
    Teachers(name: "Тутов Виталий Анатольевич", img: 'tutov.jpg', position: 'Преподаватель', items: ListOfItemsOfTutov, department: "Кафедра фундаментальной и прикладной математики", mail: "a.s.tolstukha@gmail.com"),
